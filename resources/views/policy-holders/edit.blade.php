                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    ...
                                    @forelse(Helper::$individualStates as $key => $value)
                                        <option value="{{ $key }}" @if(old('status', $policyHolder->status) == $key) selected @endif>{{ $value }}</option>
                                    @empty
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control datepicker @error('dob') is-invalid @enderror" id="dob" name="dob" value="{{ old('dob', $policyHolder->dob ? $policyHolder->dob : '') }}" readonly required>
                                @error('dob')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
                    </div>

                    <div class="mb-3 status-other-field @if(old('status', $policyHolder->status) != 'other')) d-none @endif">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="country" class="form-control" id="country" value="{{ $policyHolder->country }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="city" class="form-control" id="city" value="{{ $policyHolder->city }}" required>
