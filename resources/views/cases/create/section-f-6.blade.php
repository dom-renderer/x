        ...
        <div class="mt-4">
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                    <tr>
                        @php
                            $a = $f6Data?->where('asset_class', 'stocks')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $b = $f6Data?->where('asset_class', 'bonds')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $c = $f6Data?->where('asset_class', 'etfs')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $d = $f6Data?->where('asset_class', 'private_equity')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $e = $f6Data?->where('asset_class', 'internal_prom_note')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $f = $f6Data?->where('asset_class', 'external_prom_note')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $g = $f6Data?->where('asset_class', 'loan_receivable')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $h = $f6Data?->where('asset_class', 'real_estate')->first()?->toArray() ?? [];
                        @endphp
                        <td>Real Estate</td>
                        <td class="text-center">
                    ...
                    <tr>
                        @php
                            $i = $f6Data?->where('asset_class', 'digital_assets')->first()?->toArray() ?? [];
                        @endphp
                    ...
                    <tr>
                        @php
                            $j = $f6Data?->where('asset_class', 'other')->first()?->toArray() ?? [];
                        @endphp
                        <td>Other:</td>
                        <td class="text-center">
